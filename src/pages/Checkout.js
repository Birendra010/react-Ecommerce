      ...
      <div className="  bg-white max-w-7xl  px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  ...
                  <ul role="list">
                    {user.addresses.map((address, index) => (
                      <li
                        key={index}
                        className="flex justify-between gap-x-6 py-5 px-5 border-solid border-2 border-gray-200 shadow-sm"
                      >
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-6 bg-white max-w-7xl  px-0 sm:px-0 lg:px-3">
              <div>
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  ...
                  <div className="flow-root">
                    <ul
                      role="list"
                      className=" divide-y divide-gray-200 flex-col gap-10"
                    >
                      {items.map((item) => (
                        <li
                          key={item.id}
                        ...
                        >
                          <div className="ml-4 flex flex-1 flex-col w-64 gap-3   ">
